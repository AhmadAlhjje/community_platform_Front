...
const FeatureCard = ({ icon: Icon, title, description, delay }: any) => (
  <motion.div
    ...
    className="group"
  >
    <div className="relative h-full bg-card border rounded-lg sm:rounded-xl p-4 sm:p-6 overflow-hidden hover:shadow-lg transition-all duration-300 hover:border-primary/50">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section
        className="relative py-8 sm:py-12 md:py-16 lg:py-20 border-b overflow-hidden"
        style={{
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center overflow-hidden">
            ...
            >
              ...
              >
                ...
                <p className="text-base sm:text-lg text-white/95 mb-6 sm:mb-8 leading-relaxed drop-shadow-md">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-card/30">
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            ...
            >
              <div className="relative aspect-[4/3] rounded-lg sm:rounded-xl overflow-hidden shadow-lg">
                <Image
              ...
              <div className="relative aspect-[4/3] rounded-lg sm:rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                  <div className="flex items-center gap-2 mb-1 sm:mb-2">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-white">حب الوطن</h3>
                  </div>
                  <p className="text-xs sm:text-sm text-white/90">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="container px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10 md:space-y-12">
          <motion.div
            initial={{ opacity: 0 }}
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 border-t bg-card/20">
        <div className="container px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center overflow-hidden">
            ...
            >
              <div className="relative aspect-video rounded-lg sm:rounded-xl overflow-hidden shadow-xl">
                <Image
                  src="/images/hero-community.webp"
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                >
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5 sm:mt-1">
                    <Sparkles className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold mb-1 text-sm sm:text-base">تعلم بطريقة ممتعة</h3>
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-1 text-sm sm:text-base">شارك رأيك</h3>
                    <p className="text-xs sm:text-sm text-muted-foreground">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-1 text-sm sm:text-base">تنافس وتطور</h3>
                    <p className="text-xs sm:text-sm text-muted-foreground">
      ...
      {/* Partners Section */}
      <section className="py-10 sm:py-12 md:py-16 bg-muted/30 border-y">
        <div className="container px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            {[1].map((num, index) => (
              <motion.div
                ...
                className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-card rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-4 sm:p-6 flex items-center justify-center"
              >
      ...
      {/* CTA Section */}
      <section
        className="relative py-12 sm:py-16 md:py-20 lg:py-24 border-t overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="container relative px-4 sm:px-6 lg:px-8 max-w-full">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="max-w-2xl mx-auto text-center space-y-4 sm:space-y-6"
          >
